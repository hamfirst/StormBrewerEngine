...
{
	partial class AddServerObjectTab
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.entityLink = new System.Windows.Forms.TextBox();
			...
			this.label1.Text = "Server Object Name";
			// 
			// componentName
			// 
			...
			this.componentName.Text = "ServerObject";
			...
			// entityLink
			// 
			this.entityLink.Location = new System.Drawing.Point(461, 64);
			this.entityLink.Name = "entityLink";
			this.entityLink.Size = new System.Drawing.Size(187, 20);
			this.entityLink.TabIndex = 16;
			// 
			// label8
			// 
			...
			this.includePosition.Location = new System.Drawing.Point(227, 247);
			this.includePosition.Name = "includePosition";
			this.includePosition.Size = new System.Drawing.Size(127, 17);
			this.includePosition.TabIndex = 15;
			this.includePosition.Text = "Include Position Data";
			...
			this.Controls.Add(this.entityLink);
		...
		private System.Windows.Forms.TextBox entityLink;
