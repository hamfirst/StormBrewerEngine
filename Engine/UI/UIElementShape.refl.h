...
struct UIElementShapeInitData
{
  STORM_REFL;
};

static const float kUIElementShapeRectangle = 0;
static const float kUIElementShapeFilledRectangle = 1;
static const float kUIElementShapeCircle = 2;
static const float kUIElementShapeFilledCircle = 3;
