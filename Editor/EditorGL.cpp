...
QFunctionPointer get_proc(const char * procName)
{
	return QOpenGLContext::globalShareContext()->getProcAddress(procName);
}

static void setup_debugger()
{
    auto logger = new QOpenGLDebugLogger(QOpenGLContext::globalShareContext());
