...
public:
  ...
  NetPolymorphic(const NetPolymorphic<BaseClass> & rhs)
  {
    ...
    m_Ptr = static_cast<BaseClass *>(type_info.m_HeapCreateCopy(rhs.m_Ptr, type_info.m_Allocator));
  ...
  {
    auto & type_info = BaseClass::__s_TypeDatabase.GetTypeInfo(class_id);
    m_Ptr = static_cast<BaseClass *>(type_info.m_HeapCreateCopy(data_ptr, type_info.m_Allocator));
    m_ClassId = class_id;
    m_TypeHash = type_info.m_TypeIdHash;
  }
  ...
  NetPolymorphic(const DataType & rhs)
  {
    ...
    m_Ptr = static_cast<BaseClass *>(type_info.m_HeapCreateCopy(&rhs, type_info.m_Allocator));
  ...
  {
    auto & type_info = BaseClass::__s_TypeDatabase.template GetTypeInfo<DataType>();
    m_Ptr = static_cast<BaseClass *>(type_info.m_HeapCreateMove(&rhs, type_info.m_Allocator));
    m_ClassId = type_info.m_ClassId;
    m_TypeHash = type_info.m_TypeIdHash;
  }
  ...
  NetPolymorphic<BaseClass> & operator = (const NetPolymorphic<BaseClass> & rhs)
  {
    ...
    m_Ptr = static_cast<BaseClass *>(new_type_info.m_HeapCreateCopy(rhs.m_Ptr, new_type_info.m_Allocator));
    m_ClassId = rhs.m_ClassId;
    m_TypeHash = rhs.m_TypeHash;
  ...
  void SetType(std::size_t class_id, bool force = false)
  {
    ...
    if(m_Ptr)
    {
      auto & old_type_info = BaseClass::__s_TypeDatabase.GetTypeInfo(m_ClassId);
      old_type_info.m_HeapDestroy(m_Ptr, old_type_info.m_Allocator);
    }
