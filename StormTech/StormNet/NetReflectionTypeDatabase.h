...
#define NET_REGISTER_TYPE_IMPL(ClassName, ParentTypeHash, TypeDb, TypeList) \
  class _s_reg##ClassName { public: _s_reg##ClassName() { \
    ...
    reg.m_TypeInfo.m_HeapCreateCopy = [](const void * src, void * alloc) -> void * { auto src_ptr = static_cast<const ClassName *>(src); auto alloc_ptr = static_cast<NetPoolAllocator<ClassName> *>(alloc); return alloc_ptr->Allocate(*src_ptr); }; \
    reg.m_TypeInfo.m_HeapCreateMove = [](void * src, void * alloc) -> void * { auto src_ptr = static_cast<ClassName *>(src); auto alloc_ptr = static_cast<NetPoolAllocator<ClassName> *>(alloc); return alloc_ptr->Allocate(std::move(*src_ptr)); }; \
...
#define NET_REGISTER_ABSTRACT_TYPE_IMPL(ClassName, ParentTypeHash, TypeDb, TypeList) \
  class _s_reg##ClassName { public: _s_reg##ClassName() { \
    ...
    reg.m_TypeInfo.m_HeapCreateCopy = [](const void * src, void * alloc) -> void * { return nullptr; }; \
    reg.m_TypeInfo.m_HeapCreateMove = [](void * src, void * alloc) -> void * { return nullptr; }; \
...
struct NetTypeInfo
{
  ...
  void * (*m_HeapCreateCopy)(const void * src, void * alloc);
  void * (*m_HeapCreateMove)(void * src, void * alloc);
