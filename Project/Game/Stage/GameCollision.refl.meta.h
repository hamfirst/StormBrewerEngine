...
{
  static constexpr auto GetName() { return "kCollisionDamageable"; }
  static constexpr auto GetNameHash() { return 0x248BF42F; }
  static constexpr auto GetValue() { return GameCollisionType::kCollisionDamageable; }
};
