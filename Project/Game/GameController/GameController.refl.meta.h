...
{
  using func_ptr_type = void (GameController::*)(const PlaceholderClientEvent &, std::size_t, GameWorld &);
...
{
  using param_type = GameWorld &;
  static constexpr auto GetName() { return "game"; }
  static constexpr auto GetType() { return "GameWorld &"; }
  static constexpr unsigned GetNameHash() { return 0x232B318C; }
  static constexpr unsigned GetTypeNameHash() { return 0x7A9349E3; }
};

template <>
struct StormReflFuncInfo<GameController>::func_data_static<1>
{
  using func_ptr_type = void (GameController::*)(const JumpEvent &, std::size_t, GameWorld &);
  using return_type = void;
  static constexpr int params_n = 3;
...
{
  using func_ptr_type = void (GameController::*)(const PlaceholderServerAuthEvent &, GameWorld &);
  using return_type = void;
