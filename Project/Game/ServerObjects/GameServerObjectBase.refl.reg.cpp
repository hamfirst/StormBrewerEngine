...
REGISTER_SERVER_OBJECT_WITH_INIT_DATA(GameServerObjectBase, GameServerObjectBaseInitData, ServerObject);
STORM_DATA_DEFAULT_CONSTRUCTION_IMPL(GameServerObjectBaseInitData);
