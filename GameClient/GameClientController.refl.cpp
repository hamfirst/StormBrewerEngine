  ...
  m_GameContainer(game)
{
  ...
  auto visitor = [&](auto f)
  {
    ...
    m_EventCallbacks[class_id] = Delegate<void, void *>([=](void * ev) { (this->*func_ptr)(*(const ParamType *)ev); });
  };
...
void GameClientController::HandleGlobalEvent(std::size_t event_class_id, void * event_ptr)
{
