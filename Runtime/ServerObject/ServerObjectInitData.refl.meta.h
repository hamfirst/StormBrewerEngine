...
struct StormReflTypeInfo<ServerObjectInitData>
{
  ...
  {
    auto c = static_cast<ServerObjectInitData *>(ptr);
  ...
  {
    auto c = static_cast<const ServerObjectInitData *>(ptr);
    if(GetNameHash() == type_name_hash) return c;
    return nullptr;
  }
  ...
  {
    auto c = static_cast<ServerObjectInitData *>(ptr);
    if(typeid(ServerObjectInitData).hash_code() == type_id_hash) return c;
    return nullptr;
  }
