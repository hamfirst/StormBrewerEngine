...
class RUNTIME_EXPORT ComponentTypeSystem
{
public:
  ComponentTypeSystem();
  ~ComponentTypeSystem();
...
class RUNTIME_EXPORT ComponentSystem
{
public:
...
extern RUNTIME_EXPORT ComponentTypeSystem g_ComponentTypeSystem;
extern RUNTIME_EXPORT PreMainCallList g_ComponentRegisterCallList;
extern RUNTIME_EXPORT PreMainCallList g_ComponentUpdateDepRegisterCallList;
