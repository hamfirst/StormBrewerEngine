...
ConfigEditor::ConfigEditor(EditorContainer & editor_container, PropertyFieldDatabase & property_db, const std::string & root_path, void * config_ptr, ConfigRegistrationInfo & config_info,
