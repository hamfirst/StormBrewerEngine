...
{
	public partial class AddComponentTab : UserControl
	{
		...
		public bool SyncToServerObject { get { return syncToServerObject.Checked; } }
		...
		private void onKeyDown(object sender, KeyEventArgs e)
		{
			...
			{
				m_Parent.Type = AddComponentCommandType.Component;
