...
void StormWebrtcClient::SendPacket(int stream, bool sender_channel, const void * data, std::size_t data_len)
{
...
bool StormWebrtcClient::PollPacket(StormWebrtcClientPacket & out_packet)
{
...
void StormWebrtcClient::GotMessage(int stream, bool sender, void * data, int length)
{
