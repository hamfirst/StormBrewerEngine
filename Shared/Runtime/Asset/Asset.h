...
#define EXTERN_GLOBAL_ASSET(AssetType, AssetVar) \
  extern AssetType AssetVar;

#define EXTERN_GLOBAL_ASSET_ARRAY(AssetType, AssetVar) \
  extern AssetType * AssetVar; \
...
#define CLIENT_ONLY_ASSET(AssetType, AssetPath, AssetVar) GLOBAL_ASSET(AssetType, AssetPath, AssetVar)
