...
struct StormReflTypeInfo<MapPropertiesDef>::field_data_static<0>
{
  ...
  static constexpr auto GetMemberPtr() { return &MapPropertiesDef::m_MaxTeams; }
  static void * GetFromParent(void * obj) { auto ptr = static_cast<MapPropertiesDef *>(obj); return &ptr->m_MaxTeams; }
  static const void * GetFromParentConst(const void * obj) { auto ptr = static_cast<const MapPropertiesDef *>(obj); return &ptr->m_MaxTeams; }
};
...
struct StormReflTypeInfo<MapPropertiesDef>::field_data<0, Self> : public StormReflTypeInfo<MapPropertiesDef>::field_data_static<0>
{
  ...
  void SetDefault() { self.m_MaxTeams = StormReflTypeInfo<MapPropertiesDef>::GetDefault().m_MaxTeams; }
};
...
template <>
struct StormReflTypeInfo<MapPropertiesDef>::field_data_static<3>
{
  using member_type = uint16_t; // unsigned short
...
template <typename Self>
struct StormReflTypeInfo<MapPropertiesDef>::field_data<3, Self> : public StormReflTypeInfo<MapPropertiesDef>::field_data_static<3>
{
  Self & self;
  field_data(Self & self) : self(self) {}
