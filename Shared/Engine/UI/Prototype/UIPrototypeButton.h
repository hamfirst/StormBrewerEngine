...
public:
  ...
  UIPrototypeButton(UIManager & manager, czstr name, NullOptPtr<UIElement> parent, const Box & box, czstr caption,
          NullOptPtr<UISoundPrototypeEffects> sfx = nullptr, bool back_button = false);
