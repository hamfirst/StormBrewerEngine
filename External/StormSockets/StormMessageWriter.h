...
namespace StormSockets
{
    ...
    int m_TrailerLength;
		...
		friend class StormSocketServerWin;
    friend class StormSocketServerASIO;

	protected:

		void Init(StormFixedBlockAllocator * block_allocator, StormFixedBlockAllocator * sender_allocator, bool encrypt, int header_length, int trailer_length);
