...
namespace StormSockets
{
	...
	{
		StormMessageHeaderReader m_Reader;
		int m_GuidPos;

		uint8_t ReadByte()
		{
			if (m_Reader.m_DataLength == 0)
			{
	...
	void StormSha1::CalcHash(StormMessageHeaderReader header_reader, StormMessageWriter & writer)
	{
		StormMessageHeaderReaderSha1 reader;
		reader.m_Reader = header_reader;
		reader.m_GuidPos = 0;
		...
		int uint8_tlength = header_reader.m_DataLength + sizeof(s_WebsocketGuid);
