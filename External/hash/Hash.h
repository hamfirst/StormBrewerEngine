...
inline Hash crc32end(Hash hash)
{
  return hash ^ 0xFFFFFFFF;
}

inline Hash crc32additive(Hash hash, char c)
{
  return (hash >> 8) ^ crc_table[(hash ^ c) & 0xFF];
}

inline Hash crc32(czstr str)
{
...
inline Hash crc32(const std::string & str)
{
...
inline Hash crc32lowercase(const std::string & str)
{
