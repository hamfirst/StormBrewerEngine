...
double filter(const double* filt, const double* signal, const int K)
{
...
double basic_filter(const double* filt, const double* signal, const int K)
{
...
double sse_filtering_aligned(const double* filt, const double* signal, const int K) {
...
double sse_filtering_misaligned(const double* filt, const double* signal, const int K) {
...
double filter(const double* filt, const double* signal, int K)
{
	if (K<8)
