...
{
  using MyBase = void;
  static constexpr int funcs_n = 12;
...
template <>
struct StormReflFuncInfo<Game>::func_data_static<7>::param_info<2>
{
...
template <>
struct StormReflFuncInfo<Game>::func_data_static<7>::param_info<3>
{
  using param_type = std::string;
