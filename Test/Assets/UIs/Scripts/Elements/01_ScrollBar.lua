...
ScrollBar.border_r = 0.4
ScrollBar.border_g = 0.4
ScrollBar.border_b = 0.4
ScrollBar.border_hover_r = 0.1
ScrollBar.border_hover_g = 0.1
ScrollBar.border_hover_b = 0.7
ScrollBar.bkg_r = 0.96
ScrollBar.bkg_g = 0.96
ScrollBar.bkg_b = 1
ScrollBar.bkg_hover_r = 1
ScrollBar.bkg_hover_g = 1
ScrollBar.bkg_hover_b = 1
ScrollBar.alpha = 1
